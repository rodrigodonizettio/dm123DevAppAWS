...
public class TestController {
  ...
  public ResponseEntity<?> dogTest(@PathVariable String name) {
    log.info("Rodrigo Test Controller - Name: {}", name);
    log.info("Is matilde? {}", testService.isUserMatilde(name));
    return ResponseEntity.ok("Name: " + name);
  }

  @GetMapping("/dogcolor/{color}")
  public ResponseEntity<?> dogColorTest(@PathVariable String color) {
    log.info("Dog Color Test Controller - Name: {}", color);
