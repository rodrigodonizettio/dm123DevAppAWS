...
//    ddbClient.withRegion(Regions.fromName("eu-west-2"));
    ddbClient.withRegion(RegionUtils.getRegion("eu-west-2"));
  ...
  private String downloadObject(String bucketName, String objectKey)
    ...
    final AmazonS3Client amazonS3Client = new AmazonS3Client(
            new EnvironmentVariableCredentialsProvider());
    amazonS3Client.withRegion(RegionUtils.getRegion("eu-west-2"));
